...
?>
    ...
    try{
      ...
      $CreateOwnerTableQuery = "CREATE TABLE restaurant(RestaurantId integer NOT NULL AUTO_INCREMENT PRIMARY KEY,RestaurantName VARCHAR(255) NOT NULL,ratingNumber integer(10),star integer(10),image VARCHAR(100))";
      $con->query($CreateOwnerTableQuery);
      $CreateTableQuery = "CREATE TABLE foodanddrink(FoodId integer NOT NULL AUTO_INCREMENT PRIMARY KEY,FoodOrDrinkName VARCHAR(255) NOT NULL,Price DECIMAL(10,2) NOT NULL,foodImage VARCHAR(100),RestaurantId integer REFERENCES restaurant(RestaurantId) )";
    ...
    if($result->num_rows > 0){
      ...
      if($result->num_rows > 0){
        ...
        if($_FILES['foodOrDrinkfile']['name']!= null){
      ...
      #when the restaurant is no exist
        ...
        if($_FILES['restaurantfile']['name']!= null){
