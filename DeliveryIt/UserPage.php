...
<html lang="en" dir="ltr">
  ...
  <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class = "container-fluid">
            <div class = "navbar-header">
              <a class = "navbar-brand" href = "#"> DeliveryIt </a>
            </div>
    ...
    <div class = "container">
      <h2>About</h2><br>
      <p> DeliveryIt aims to develop a website that allows users to buy food through an online website so that customers don’t have to wait in line,
          don’t have to worry about the Covid-19 disease or if the customers feel that travelling takes a lot of time.</p><br>
      <h2> Contact </h2><br>
    ...
    <df-messenger
      intent="WELCOME"
      chat-title="DeliveryItUser"
      agent-id="6a2b2e29-c7d8-4410-8533-5c95b52c611e"
      language-code="en"
    ></df-messenger>
